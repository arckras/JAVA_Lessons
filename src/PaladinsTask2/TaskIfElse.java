...
public class TaskIfElse {
    ...
    public static void main(String args[]) {
        ...
        СomparisonWith10(sc);
        СomparisonAndBooleanOperators(sc);
        StringComparison(sc);
        FigureSkatingFreeProgram(sc);
    }
    ...
    private static void СomparisonAndBooleanOperators(Scanner sc) {
        System.out.print("\n2. --------- ");
        ...
        a = 67;
        b = 23;
        statement = a < b;//при этих условиях вывода никогда не будет
        if (statement) {
            System.out.println("a < b " + statement);
        }
        a = 90;
    ...
    private static void FigureSkatingFreeProgram(Scanner sc) {
        System.out.print("\n4. --------- ");
        int value1, value2;
