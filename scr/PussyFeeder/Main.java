...
public class Main {
        ...
        for (; ; ) {
            ...
            switch (choiceActions) {
                case 1:
                    ...
                    choiceCat = intScanner(); //выбираем кота и проверяем целочисленность
                    if (isBowl(choiceCat))
    ...
    private static int intScanner() {
        //метод принимает число и проверяет целочисленность
    ...
    private static boolean isBowl(int numberCat) {
    ...
    private static void putPackage(int numberCat) {
